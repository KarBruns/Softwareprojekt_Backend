...
public class Techniker implements Serializable {
    ...
    @Id
    @SequenceGenerator(name="SP_Techniker_Id", sequenceName="SEQ_Techniker_Id", allocationSize = 100)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SP_Techniker_Id")
